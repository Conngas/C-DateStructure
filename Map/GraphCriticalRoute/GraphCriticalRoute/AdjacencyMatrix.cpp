...
void InsertEdge(SAdjacnecyMatrix* pSAdjMtrix, VerList DverFirst, VerList DverSecond,Wright DWright)
{
	...
	pSAdjMtrix->ppiEdge[iVerPosF][iVerPosS] = DWright;
